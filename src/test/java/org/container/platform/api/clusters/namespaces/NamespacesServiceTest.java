...
public class NamespacesServiceTest {
    ...
    public void createInitNamespaces_Valid_ReturnModel() {
        ...
        when(propertyService.getAdminRole()).thenReturn("container-platform-admin-role");
        when(resourceYamlService.createRoleBinding(NAMESPACE_ADMIN_USER_ID, NAMESPACE, "container-platform-admin-role")).thenReturn(gFinalResultStatusModel);
        ...
        when(propertyService.getDefaultNamespace()).thenReturn("container-platform-temp-namespace");
        when(usersService.getUsers(CLUSTER, "container-platform-temp-namespace", NAMESPACE_ADMIN_USER_ID)).thenReturn(newNsUser);
        newNsUser.setId(0);
        newNsUser.setCpNamespace(NAMESPACE);
        when(propertyService.getAdminRole()).thenReturn("container-platform-admin-role");
        newNsUser.setRoleSetCode("container-platform-admin-role");
    ...
    public void modifyInitNamespaces_Valid_ReturnModel() throws Exception {
        ...
        when(propertyService.getAdminRole()).thenReturn("container-platform-admin-role");
        when(resourceYamlService.createRoleBinding(nsAdminUserId, NAMESPACE, "container-platform-admin-role")).thenReturn(gFinalResultStatusModel);
        ...
        when(propertyService.getDefaultNamespace()).thenReturn("container-platform-temp-namespace");
        Users newNsUser = new Users();
        when(usersService.getUsers(CLUSTER, "container-platform-temp-namespace", nsAdminUserId)).thenReturn(newNsUser);
        newNsUser.setId(0);
        newNsUser.setCpNamespace(NAMESPACE);
        when(propertyService.getAdminRole()).thenReturn("container-platform-admin-role");
        newNsUser.setRoleSetCode("container-platform-admin-role");
    ...
    public void modifyResourceQuotas_Valid_ReturnModel() throws Exception{
        ...
        requestUpdatedRqList.add("container-platform-low-rq");
        ...
        toBeDelete.add("container-platform-low-rq");
        ...
        toBeAdd.add("container-platform-low-rq");
    ...
    public void modifyLimitRanges_Valid_ReturnModel() throws Exception{
        ...
        requestUpdatedLrList.add("container-platform-low-limit-range");

...
public class PodsServiceTest {
    ...
    public void getPodsListByNodeAdmin_allNamespace_Valid_ReturnModel() {
        // given
        String ignoreNamesapceQuery = "?fieldSelector=metadata.namespace!=kubernetes-dashboard,metadata.namespace!=kube-node-lease,metadata.namespace!=kube-public,metadata.namespace!=kube-system,metadata.namespace!=default,metadata.namespace!=container-platform-temp-namespace,metadata.namespace!=temp-namespace";
